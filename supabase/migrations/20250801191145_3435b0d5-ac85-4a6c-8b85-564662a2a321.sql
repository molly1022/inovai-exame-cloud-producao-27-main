...
-- 1. Excluir dados relacionados de todas as clínicas EXCETO a Unimed
...
-- 2. Excluir usuários de outras clínicas
...
-- 3. Excluir configurações de outras clínicas
...
-- 4. Excluir outras clínicas (manter apenas a Unimed)
DELETE FROM public.clinicas 
WHERE id != 'cd66c1b3-3684-4358-a0cf-b51d8b75041f';

-- 5. Limpar códigos de recuperação e logs antigos
