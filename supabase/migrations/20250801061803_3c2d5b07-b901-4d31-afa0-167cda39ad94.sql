...
('basico_medico', 6, 125.00, 10.0, 112.50, 4, 5, 'por_medico', true),
-- Plano Intermediário Semestral (6 meses)  
('intermediario_medico', 6, 190.00, 10.0, 171.00, 4, 5, 'por_medico', true),
-- Plano Avançado Semestral (6 meses)
('avancado_medico', 6, 299.00, 10.0, 269.10, 4, 5, 'por_medico', true);
...
BEGIN
    ...
    SELECT pa.valor_final, a.periodo_meses, pa.percentual_desconto
    INTO plano_info
    FROM assinaturas a
