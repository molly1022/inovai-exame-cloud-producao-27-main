...
-- Versão corrigida respeitando foreign key constraints

-- 1. Excluir registros da tabela usuarios primeiro (para evitar constraint violation)
DELETE FROM public.usuarios 
WHERE clinica_id != 'cd66c1b3-3684-4358-a0cf-b51d8b75041f';

-- 2. Excluir dados relacionados de todas as clínicas EXCETO a Unimed
...
-- 3. Excluir usuários de outras clínicas (agora sem constraint violations)
...
-- 4. Excluir configurações de outras clínicas
...
-- 5. Excluir outras clínicas (manter apenas a Unimed)
DELETE FROM public.clinicas 
WHERE id != 'cd66c1b3-3684-4358-a0cf-b51d8b75041f';

-- 6. Limpar códigos de recuperação e logs antigos
