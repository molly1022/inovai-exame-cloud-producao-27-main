-- Corrigir constraint e continuar implementação Database-per-Tenant

-- Adicionar constraint única na tabela schema_templates
ALTER TABLE public.schema_templates 
ADD CONSTRAINT unique_schema_template_nome_versao UNIQUE (nome, versao);

-- Inserir template de schema padrão (agora com constraint correta)
